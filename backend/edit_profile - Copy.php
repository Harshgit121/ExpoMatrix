...
$sql = "SELECT * FROM organizer WHERE User_Name=?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_profile'])) {
    ...
    $updateSql = "UPDATE organizer SET Full_Name=?, Email=?, Phone_Number=? WHERE User_Name=?";
        ...
        <div class="edit-form">
          ...
          <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="form-group">
              ...
              <input type="text" id="username" value="<?php echo htmlspecialchars($organizer['User_Name']); ?>" disabled>
              <small>Username cannot be changed</small>
            </div>
            
            <div class="form-group">
              <label for="fullName">Full Name</label>
              <input type="text" id="fullName" name="fullName" value="<?php echo htmlspecialchars($organizer['Full_Name']); ?>" required>
            </div>
            
            <div class="form-group">
              <label for="email">Email Address</label>
              <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($organizer['Email']); ?>" required>
            </div>
            
            <div class="form-group">
              <label for="phone">Phone Number</label>
              <input type="text" id="phone" name="phone" value="<?php echo htmlspecialchars($organizer['Phone_Number']); ?>" required>
            </div>
            
            <div class="btn-container">
              <a href="organizer_profile.php" class="cancel-btn">Cancel</a>
